...
| --- | --- | --- | --- |
| Anti-patterns | [`anti-patterns/`](../anti-patterns/README.md) | Documented pitfalls, per domain and per named pattern | Common Mistakes section |
...
- **Every article's Common Mistakes section links the domain's entry** in the shared catalog: `[the domain's anti-patterns](../../../anti-patterns/README.md#<domain>)`, plus its own `#common-mistakes` anchor. This is a required typed relation (`common_mistakes`).
