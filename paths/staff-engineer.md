...
> A technical leader who sets direction, drives consistency, and multiplies teams across a large frontend.

**Level:** Staff · **Required:** 95 articles (~26.4 h) · **Optional:** 17 articles (~3.3 h)

Difficulty of required articles: Intermediate 23 · Advanced 52 · Staff 20.
...
1. Drive technical strategy, RFCs, and cross-team standards
2. Architect composition and design systems at scale
3. Own release safety, incident response, and supply-chain risk
4. Multiply teams through DX, guardrails, and mentorship
5. Balance innovation against stability in technology choices

## Expected skills

By completing the required articles you should be able to:

- Technical direction and decision-making at scale
- Org-wide architecture, standards, and consistency
- Production reliability, security, and risk ownership
- Leadership, mentorship, and technology strategy
...
- [Estimation](../docs/08-craft-leadership/systems-thinking-leadership/estimation.md) · Staff · 20 min
- [Scoping & Slicing Work](../docs/08-craft-leadership/systems-thinking-leadership/scoping-and-slicing-work.md) · Staff · 20 min
- [Risk Management](../docs/08-craft-leadership/systems-thinking-leadership/risk-management.md) · Staff · 20 min
- [Cross-Functional Partnership](../docs/08-craft-leadership/systems-thinking-leadership/cross-functional-partnership.md) · Staff · 23 min
- [Influence Without Authority](../docs/08-craft-leadership/systems-thinking-leadership/influence-without-authority.md) · Staff · 23 min
- [Communicating Technical Concepts](../docs/08-craft-leadership/systems-thinking-leadership/communicating-technical-concepts.md) · Staff · 23 min
- [Mentorship](../docs/08-craft-leadership/systems-thinking-leadership/mentorship.md) · Staff · 20 min
- [Technical Leadership Styles](../docs/08-craft-leadership/systems-thinking-leadership/technical-leadership-styles.md) · Staff · 23 min
- [Evaluating Technology](../docs/08-craft-leadership/systems-thinking-leadership/evaluating-technology.md) · Staff · 20 min
- [Adoption & Migration Strategy](../docs/08-craft-leadership/systems-thinking-leadership/adoption-and-migration-strategy.md) · Staff · 23 min
- [Innovation vs Stability](../docs/08-craft-leadership/systems-thinking-leadership/innovation-vs-stability.md) · Staff · 20 min
...
- [Documentation Practices](../docs/08-craft-leadership/engineering-practices/documentation-practices.md) · Advanced · 16 min
- [Knowledge Sharing & Bus Factor](../docs/08-craft-leadership/engineering-practices/knowledge-sharing-and-bus-factor.md) · Advanced · 19 min
...
- [Dependency Vulnerabilities](../docs/05-reliability-quality/security/dependency-vulnerabilities.md) · Advanced · 16 min
- [Lockfiles & Provenance](../docs/05-reliability-quality/security/lockfiles-and-provenance.md) · Advanced · 16 min
- [Third-Party Script Risk](../docs/05-reliability-quality/security/third-party-script-risk.md) · Advanced · 16 min
- [Data Handling & PII](../docs/05-reliability-quality/security/data-handling-and-pii.md) · Advanced · 16 min
- [Consent & Tracking](../docs/05-reliability-quality/security/consent-and-tracking.md) · Advanced · 16 min
- [Regulatory Compliance](../docs/05-reliability-quality/security/regulatory-compliance.md) · Advanced · 16 min
